...
BIT_DEF(BASELINE_CORRECTION_MODE,			0x01, 0);
/* F54_ANALOG_CTRL113: General Control */
BIT_DEF(DISABLE_HYBRID_BASELINE,			0x20, 5);
...
static int clearpad_enable_wakeup_gesture(struct clearpad_t *this)
{
	...
	if (this->chip_id == SYN_CHIP_3330 &&
		...
		rc = clearpad_put_bit(SYNF(this, F54_ANALOG, CTRL, 0x3B),
		...
		rc = clearpad_put(SYNF(this, F54_ANALOG, CTRL, 0x3A),
		...
		rc = clearpad_put_bit(SYNF(this, F54_ANALOG, CTRL, 0x55), 0,
...
reg_F12_2D:
	...
	if (clearpad_debug_print_reg("F54_ANALOG_CTRL109_00: General Control",
		     SYNF(this, F54_ANALOG, CTRL, 0x3A), buf, 1) == 0) {
	...
	if (clearpad_debug_print_reg("F54_ANALOG_CTRL113_00: General Control",
		     SYNF(this, F54_ANALOG, CTRL, 0x3B), buf, 1) == 0) {
	...
	if (clearpad_debug_print_reg("F54_ANALOG_CTRL214_00: General Control",
		     SYNF(this, F54_ANALOG, CTRL, 0x55), buf, 1) == 0) {
